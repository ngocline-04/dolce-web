...
const DetailWage: NextPageWithLayout = () => {
    ...
    <>
      ...
      <Card title="Phiếu lương > Chi tiết">
        ...
        <div className='w-full flex justify-end mt-16'>
          <Button onClick={() => window.history.back()} className="mb-16">
            Huỷ
          </Button>
          <Button type="primary" onClick={() => window.history.back()} className="mb-16 ml-16">
            Lưu
          </Button>
        </div>
      </Card>
...
DetailWage.Layout = AppLayout;

export default DetailWage;
